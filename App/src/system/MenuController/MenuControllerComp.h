...
namespace ecs
{
	...
	/// <summary>
	/// 画面全体を覆う色付きオーバーレイ(Sprite)に付与するタグ。
	/// MenuPagingSystemがMenuControllerComp::ActiveSpellIDの変化に合わせて毎フレーム
	/// Color(WeaponSelectVisuals::GetWeaponAccentColor)を書き換える(選択中の武器の
	/// イメージカラーで画面全体を軽く染める演出)。
	/// </summary>
	struct MenuBackgroundTintUiTag
	{
	};

	/// <summary>初期武器選択画面の操作案内テキストに付与するタグ。「Selectって何ボタン？」と
	/// ならないよう、MenuInputSystemが最後に使われた入力デバイスに応じて毎フレーム内容を更新する</summary>
